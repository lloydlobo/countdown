...
const AddSound: React.FC<AddSoundProps> = ({ onSoundAdded, open, onOpenChange, ...props }) => {
    ...
    >
      <DialogContent>
        ...
        <div className="mb-2">
          ...
          <Button
            onClick={handleClick}
            className="flex aspect-[22/9] w-full flex-col items-center justify-center"
            variant="outline"
          >
            <Upload className="h-12 w-12" />

            <p className="mt-2 text-base font-medium">
              {localSoundFile ? localSoundFile.name : "Upload your notification sound"}
            </p>
